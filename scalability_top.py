...
instance.TemplateURL =  "https://s3-eu-west-1.amazonaws.com/" + configuration.BUCKET_NAME + "/scalability_vpc.json"
...
instance.TemplateURL = "https://s3-eu-west-1.amazonaws.com/" + configuration.BUCKET_NAME + "/scalability_couchbase.json"
instance.TimeoutInMinutes = 60
